...
if __name__ == '__main__':
    ...
    for dataset in datasets:
        reliability_list = []
        data = get_dataset(seeds, dataset, 'active', args.data_format, params_dict['DATA_PATH'], None, 0, args.no_val, args.budget, 
                            args.strategy, args.num_centers, args.compensation, args.save_data, args.filter_strategy, args.max_part, 1 - args.pl_noise, reliability_list, args.total_budget, 'none', False, all_args=args)
