...
def load_amazon_data(dataset_name, feature_type, use_dgl, use_text=False,use_generate_text = False):
    ...
    if dataset_name == 'amazon-computers':
        '''
        csv_dir = 'C:/Users/user1/Desktop/dataset/computers/Computers_Final_with_W2V_embeddings.csv'
        ...
        '''
        csv_dir = 'C:/Users/user1/Desktop/dataset/photo/Photo_Final_with_W2V_embeddings.csv'
        data = build_data_from_csv(csv_dir)
        '''
        if feature_type=="BOW":
        ...
        '''
        csv_dir = 'C:/Users/user1/Desktop/dataset/history/History_Final_with_BoW_embeddings.csv'
        data = build_data_from_csv(csv_dir)
        '''
        if feature_type=="BOW":
